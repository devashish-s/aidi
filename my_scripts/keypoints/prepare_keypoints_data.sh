...
csv_file_path="/workspace/ai-tailer-detectron/input_data/data_kps.csv"
json_file_path="/workspace/ai-tailer-detectron/input_data/data_kps.json"
python csv2json_conversion.py --input_csv "$csv_file_path" --output_json "$json_file_path"

## ===================================================================================== ##

# Step2: Generate Masks For Input Data
images_folder_path="/workspace/ai-tailer-detectron/input_data/image_processed"
output_mask_folder_path="/workspace/ai-tailer-detectron/output_data/masks"
...
input_backgrounds_folder="/workspace/ai-tailer-detectron/input_data/keypoint-detection/dataset/backgrounds/bg_sm"
output_augmented_dir="/workspace/ai-tailer-detectron/input_data/data_for_training"
