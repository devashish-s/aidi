...
if __name__ == "__main__":
    input_folder = "/workspace/ai-tailer-detectron/input_data/images/front"  # Replace with your input folder path
    output_folder = "/workspace/ai-tailer-detectron/output_data/images/front"  # Replace with your output folder path
